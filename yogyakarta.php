...
<div class="h3_title"><h3>ホテルで決める旅 ヴィラ・ホテル villa &amp; hotel</h3></div>
    ...
    <div class="box">
<?php $myposts = get_posts('category_name=villa-yogyakarta-pickup&posts_per_page=999');/*VILLA記事ピックアップリスティング*/ ?>
...
<div class="list">
<ul>
<?php $myposts = get_posts('category_name=villa-yogyakarta&posts_per_page=999');/*VILLA記事ピックアップ以外リスティング*/ ?>
<?php foreach($myposts as $post): ?>
	<?php setup_postdata($post); ?>
    <?php if( in_category('villa-yogyakarta-pickup')): ?>
    <?php else : ?>
