...
<div id="container">
<div id="contents">
<ul id="breadcrumb"><li><a href="http://www.plbali.com">バリ旅行HOME</a></li><li>&nbsp;＞&nbsp;<a href="http://www.plbali.com/villa/">ヴィラ・ホテル</a>&nbsp;＞&nbsp;チャンディダサ（マンギス）地区</li></ul>
...
<h1 id="list_candidasa">チャンディダサ（マンギス）地区</h1>
<div id="info_link"><a href="/candidasa/"><img src="/img/list_link_candidasa.gif" width="325" height="18" alt="チャンディダサの基本情報はこちら"></a></div>
</div>
...
<div class="h2_title"><h2 class="cand_h2">ヴィラ一覧</h2></div>
<div class="villa_list box">
<div class="cand">
    <div class="box">
<?php $myposts = get_posts('category_name=villa-candidasa&tag=list_villa&orderby=title&order=ASC&posts_per_page=999');/*VILLA記事リスティング*/ ?>
...
<?php if ($postup){ /*記事があれば表示*/ ?>
<div class="h2_title"><h2 class="cand_h2">ホテル一覧</h2></div>
<div class="villa_list box">
<div class="cand">
    <div class="box">
<?php $myposts = get_posts('category_name=villa-candidasa&tag=list_hotel&orderby=title&order=ASC&posts_per_page=999');/*VILLA記事リスティング*/ ?>
<?php foreach($myposts as $post): ?>
	<?php setup_postdata($post); ?>
    <div class="list">
    <div class="list_img"><a href="<?php the_permalink(); ?>" target="_top"><?php $title= get_the_title(); the_post_thumbnail(array( 100,100 ),array( 'alt' =>$title, 'title' => $title)); ?></a></div>
