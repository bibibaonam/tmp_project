...
<div id="container">
<div id="contents">
<ul id="breadcrumb"><li><a href="http://www.plbali.com">バリ旅行HOME</a></li><li>&nbsp;＞&nbsp;<a href="http://www.plbali.com/villa/">ヴィラ・ホテル</a>&nbsp;＞&nbsp;その他の地域</li></ul>
...
<a href="/villa/list-ubud/">ウブド</a>｜<a href="/villa/list-semi/">スミニャック/クロボカン</a>｜<a href="/villa/list-kuta/">クタ/レギャン</a>｜<a href="/villa/list-jim/">ジンバラン/ウルワツ</a>｜<a href="/villa/list-nusa/">ヌサドゥア</a>｜<a href="/villa/list-sanur/">サヌール</a>｜<a href="/villa/list-other/">その他の地域</a>
</div>

<div id="villa_list_title"><h1 id="list_other">その他の地域</h1></div>

<div class="box">
<?php $postup = get_posts( 'category_name=villa-other&tag=list_villa' ); ?>
<?php if ($postup){ /*記事があれば表示*/ ?>
<div class="h2_title"><h2 class="other_h2">ヴィラ一覧</h2></div>
<div class="villa_list box">
<div class="other">
    <div class="box">
<?php $myposts = get_posts('category_name=villa-other&tag=list_villa&orderby=title&order=ASC&posts_per_page=999');/*VILLA記事リスティング*/ ?>
...
<?php $postup = get_posts( 'category_name=villa-other&tag=list_hotel' ); ?>
<?php if ($postup){ /*記事があれば表示*/ ?>
<div class="h2_title"><h2 class="other_h2">ホテル一覧</h2></div>
<div class="villa_list box">
<div class="other">
    <div class="box">
<?php $myposts = get_posts('category_name=villa-other&tag=list_hotel&orderby=title&order=ASC&posts_per_page=999');/*VILLA記事リスティング*/ ?>
<?php foreach($myposts as $post): ?>
	<?php setup_postdata($post); ?>
    <div class="list">
    <div class="list_img"><a href="<?php the_permalink(); ?>" target="_top"><?php $title= get_the_title(); the_post_thumbnail(array( 100,100 ),array( 'alt' =>$title, 'title' => $title)); ?></a></div>
...
<div class="h2_title"><h2 class="other_h2">体験レポート</h2></div>
<div class="villa_list box">
<div class="other">
    <div class="box">
    <div class="list">
<p>
<a href="http://www.tabikobo.com/bali/report/spot/rice_terrace/" target="blank">・ライステラス（ジャティルイ・観光）</a><br>
<a href="http://www.tabikobo.com/bali/report/spot/lempuyang/" target="blank">・ランプヤン寺院（チャンディダサ・観光）</a>
</p>
　　</div>
　　</div>
</div>
