...
<div id="container">
<div id="contents">
<ul id="breadcrumb"><li><a href="http://www.plbali.com">バリ旅行HOME</a></li><li>&nbsp;＞&nbsp;<a href="http://www.plbali.com/villa/">ヴィラ・ホテル</a>&nbsp;＞&nbsp;スタッフおすすめ</li></ul>
...
<div id="villa_list_title"><h1 id="list_staff">スタッフおすすめ</h1></div>

<div class="box">
<?php $postup = get_posts( 'category_name=villa-ubud&tag=list_staff' ); ?>
<?php if ($postup){ /*記事があれば表示*/ ?>
<div class="h2_title"><h2 class="ubud_h2">ウブド</h2></div>
<div class="villa_list box">
<div class="ubdo">
    <div class="box">
<?php $myposts = get_posts('category_name=villa-ubud&tag=list_staff&orderby=title&order=ASC&posts_per_page=999');/*VILLA記事リスティング*/ ?>
...
<?php $postup = get_posts( 'category_name=villa-seminyak-kerobokan&tag=list_staff' ); ?>
<?php if ($postup){ /*記事があれば表示*/ ?>
<div class="h2_title"><h2 class="sk_h2">スミニャック／クロボカン</h2></div>
<div class="villa_list box">
<div class="semi">
    <div class="box">
<?php $myposts = get_posts('category_name=villa-seminyak-kerobokan&tag=list_staff&orderby=title&order=ASC&posts_per_page=999'); ?>
<?php foreach($myposts as $post): ?>
	<?php setup_postdata($post); ?>
    <div class="list">
    <div class="list_img"><a href="<?php the_permalink(); ?>" target="_top"><?php $title= get_the_title(); the_post_thumbnail(array( 100,100 ),array( 'alt' =>$title, 'title' => $title)); ?></a></div>
...
<?php $postup = get_posts( 'category_name=villa-kuta-legian&tag=list_staff' ); ?>
<?php if ($postup){ /*記事があれば表示*/ ?>
<div class="h2_title"><h2 class="kl_h2">クタ／レギャン</h2></div>
<div class="villa_list box">
<div class="kuta">
    <div class="box">
<?php $myposts = get_posts('category_name=villa-kuta-legian&tag=list_staff&orderby=title&order=ASC&posts_per_page=999'); ?>
<?php foreach($myposts as $post): ?>
	<?php setup_postdata($post); ?>
    <div class="list">
    <div class="list_img"><a href="<?php the_permalink(); ?>" target="_top"><?php $title= get_the_title(); the_post_thumbnail(array( 100,100 ),array( 'alt' =>$title, 'title' => $title)); ?></a></div>
...
<?php $postup = get_posts( 'category_name=villa-jimbaran-uluwatu&tag=list_staff' ); ?>
<?php if ($postup){ /*記事があれば表示*/ ?>
<div class="h2_title"><h2 class="ju_h2">ジンバラン／ウルワツ</h2></div>
<div class="villa_list box">
<div class="jim">
    <div class="box">
<?php $myposts = get_posts('category_name=villa-jimbaran-uluwatu&tag=list_staff&orderby=title&order=ASC&posts_per_page=999'); ?>
<?php foreach($myposts as $post): ?>
	<?php setup_postdata($post); ?>
    <div class="list">
    <div class="list_img"><a href="<?php the_permalink(); ?>" target="_top"><?php $title= get_the_title(); the_post_thumbnail(array( 100,100 ),array( 'alt' =>$title, 'title' => $title)); ?></a></div>
...
<?php $postup = get_posts( 'category_name=villa-nusadua&tag=list_staff' ); ?>
<?php if ($postup){ /*記事があれば表示*/ ?>
<div class="h2_title"><h2 class="nusadua_h2">ヌサドゥア</h2></div>
<div class="villa_list box">
<div class="nusa">
    <div class="box">
<?php $myposts = get_posts('category_name=villa-nusadua&tag=list_staff&orderby=title&order=ASC&posts_per_page=999'); ?>
<?php foreach($myposts as $post): ?>
	<?php setup_postdata($post); ?>
    <div class="list">
    <div class="list_img"><a href="<?php the_permalink(); ?>" target="_top"><?php $title= get_the_title(); the_post_thumbnail(array( 100,100 ),array( 'alt' =>$title, 'title' => $title)); ?></a></div>
...
<?php $postup = get_posts( 'category_name=villa-sanur&tag=list_staff' ); ?>
<?php if ($postup){ /*記事があれば表示*/ ?>
<div class="h2_title"><h2 class="sanur_h2">サヌール</h2></div>
<div class="villa_list box">
<div class="sanu">
    <div class="box">
<?php $myposts = get_posts('category_name=villa-sanur&tag=list_staff&orderby=title&order=ASC&posts_per_page=999'); ?>
<?php foreach($myposts as $post): ?>
	<?php setup_postdata($post); ?>
    <div class="list">
    <div class="list_img"><a href="<?php the_permalink(); ?>" target="_top"><?php $title= get_the_title(); the_post_thumbnail(array( 100,100 ),array( 'alt' =>$title, 'title' => $title)); ?></a></div>
...
<?php $postup = get_posts( 'category_name=villa-canggu&tag=list_staff' ); ?>
<?php if ($postup){ /*記事があれば表示*/ ?>
<div class="h2_title"><h2 class="cang_h2">チャングー</h2></div>
<div class="villa_list box" id="canggu_list">
<div class="cang">
    <div class="box">
<?php $myposts = get_posts('category_name=villa-canggu&tag=list_staff&orderby=title&order=ASC&posts_per_page=999'); ?>
<?php foreach($myposts as $post): ?>
	<?php setup_postdata($post); ?>
    <div class="list">
    <div class="list_img"><a href="<?php the_permalink(); ?>" target="_top"><?php $title= get_the_title(); the_post_thumbnail(array( 100,100 ),array( 'alt' =>$title, 'title' => $title)); ?></a></div>
...
<?php $postup = get_posts( 'category_name=villa-candidasa&tag=list_staff' ); ?>
<?php if ($postup){ /*記事があれば表示*/ ?>
<div class="h2_title"><h2 class="cand_h2">チャンディダサ（マンギス）</h2></div>
<div class="villa_list box" id="candidasa_list">
<div class="cand">
    <div class="box">
<?php $myposts = get_posts('category_name=villa-candidasa&tag=list_staff&orderby=title&order=ASC&posts_per_page=999'); ?>
<?php foreach($myposts as $post): ?>
	<?php setup_postdata($post); ?>
    <div class="list">
    <div class="list_img"><a href="<?php the_permalink(); ?>" target="_top"><?php $title= get_the_title(); the_post_thumbnail(array( 100,100 ),array( 'alt' =>$title, 'title' => $title)); ?></a></div>
...
<?php $postup = get_posts( 'category_name=villa-tanahlot&tag=list_staff' ); ?>
<?php if ($postup){ /*記事があれば表示*/ ?>
<div class="h2_title"><h2 class="tana_h2">タナロット（タバナン）</h2></div>
<div class="villa_list box" id="tanahlot_list">
<div class="tana">
    <div class="box">
<?php $myposts = get_posts('category_name=villa-tanahlot&tag=list_staff&orderby=title&order=ASC&posts_per_page=999'); ?>
<?php foreach($myposts as $post): ?>
	<?php setup_postdata($post); ?>
    <div class="list">
    <div class="list_img"><a href="<?php the_permalink(); ?>" target="_top"><?php $title= get_the_title(); the_post_thumbnail(array( 100,100 ),array( 'alt' =>$title, 'title' => $title)); ?></a></div>
...
<?php $postup = get_posts( 'category_name=villa-menjangan&tag=list_staff' ); ?>
<?php if ($postup){ /*記事があれば表示*/ ?>
<div class="h2_title"><h2 class="menj_h2">ムンジャンガン</h2></div>
<div class="villa_list box" id="menjangan_list">
<div class="menj">
    <div class="box">
<?php $myposts = get_posts('category_name=villa-menjangan&tag=list_staff&orderby=title&order=ASC&posts_per_page=999'); ?>
<?php foreach($myposts as $post): ?>
	<?php setup_postdata($post); ?>
    <div class="list">
    <div class="list_img"><a href="<?php the_permalink(); ?>" target="_top"><?php $title= get_the_title(); the_post_thumbnail(array( 100,100 ),array( 'alt' =>$title, 'title' => $title)); ?></a></div>
...
<?php $postup = get_posts( 'category_name=villa-lovina&tag=list_staff' ); ?>
<?php if ($postup){ /*記事があれば表示*/ ?>
<div class="h2_title"><h2 class="lovi_h2">ロビナ</h2></div>
<div class="villa_list box" id="lovina_list">
<div class="lovi">
    <div class="box">
<?php $myposts = get_posts('category_name=villa-lovina&tag=list_staff&orderby=title&order=ASC&posts_per_page=999'); ?>
<?php foreach($myposts as $post): ?>
	<?php setup_postdata($post); ?>
    <div class="list">
    <div class="list_img"><a href="<?php the_permalink(); ?>" target="_top"><?php $title= get_the_title(); the_post_thumbnail(array( 100,100 ),array( 'alt' =>$title, 'title' => $title)); ?></a></div>
...
<?php $postup = get_posts( 'category_name=villa-yogyakarta&tag=list_staff' ); ?>
<?php if ($postup){ /*記事があれば表示*/ ?>
<div class="h2_title"><h2 class="yogy_h2">ジョグジャカルタ</h2></div>
<div class="villa_list box" id="yogyakarta_list">
<div class="yogy">
    <div class="box">
<?php $myposts = get_posts('category_name=villa-yogyakarta&tag=list_staff&orderby=title&order=ASC&posts_per_page=999'); ?>
<?php foreach($myposts as $post): ?>
	<?php setup_postdata($post); ?>
    <div class="list">
    <div class="list_img"><a href="<?php the_permalink(); ?>" target="_top"><?php $title= get_the_title(); the_post_thumbnail(array( 100,100 ),array( 'alt' =>$title, 'title' => $title)); ?></a></div>
...
<?php $postup = get_posts( 'category_name=villa-lombok&tag=list_staff' ); ?>
<?php if ($postup){ /*記事があれば表示*/ ?>
<div class="h2_title"><h2 class="lomb_h2">ロンボク島</h2></div>
<div class="villa_list box" id="lombok_list">
<div class="lomb">
    <div class="box">
<?php $myposts = get_posts('category_name=villa-lombok&tag=list_staff&orderby=title&order=ASC&posts_per_page=999'); ?>
<?php foreach($myposts as $post): ?>
	<?php setup_postdata($post); ?>
    <div class="list">
    <div class="list_img"><a href="<?php the_permalink(); ?>" target="_top"><?php $title= get_the_title(); the_post_thumbnail(array( 100,100 ),array( 'alt' =>$title, 'title' => $title)); ?></a></div>
...
<?php $postup = get_posts( 'category_name=villa-lembongan&tag=list_staff' ); ?>
<?php if ($postup){ /*記事があれば表示*/ ?>
<div class="h2_title"><h2 class="lemb_h2">レンボンガン島</h2></div>
<div class="villa_list box" id="lembongan_list">
<div class="lemb">
    <div class="box">
<?php $myposts = get_posts('category_name=villa-lembongan&tag=list_staff&orderby=title&order=ASC&posts_per_page=999'); ?>
<?php foreach($myposts as $post): ?>
	<?php setup_postdata($post); ?>
    <div class="list">
    <div class="list_img"><a href="<?php the_permalink(); ?>" target="_top"><?php $title= get_the_title(); the_post_thumbnail(array( 100,100 ),array( 'alt' =>$title, 'title' => $title)); ?></a></div>
